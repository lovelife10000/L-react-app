export default {
  ...
  getArticleListRequest:'GET_ARTICLE_lIST_REQUEST',
  getArticleListSuccess:'GET_ARTICLE_lIST_SUCCESS',
  getArticleListFailure:'GET_ARTICLE_lIST_FAILURE',

  addArticleListRequest:'Add_ARTICLE_lIST_REQUEST',
  addArticleListSuccess:'Add_ARTICLE_lIST_SUCCESS',
  addArticleListFailure:'Add_ARTICLE_lIST_FAILURE',

  getRecommendData:'GET_RECOMMEND_DATA',
  getRecommendDataRequest:'GET_RECOMMEND_DATA_REQUEST',
